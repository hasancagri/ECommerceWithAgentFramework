...
// 048 US2 — BehaviorSignal.Create dogrulama: bilinen eventType + dolu anonim kimlik.
// 049 kesim: liste sinyalleri (ListShown/Category/Brand/Search) + SessionId/SearchTerm/SchemaVersion sokuldu.
public class BehaviorSignalTests
{
    ...
    {
        var result = BehaviorSignal.Create(eventType, "web", null, AnonymousId,
            ProductId, "Acme", "Electronics", 199.90m, Occurred);
    ...
    [InlineData("")]
    [InlineData("productviewed")]
    // Liste/sonuc sayfasi sinyalleri artik REDDEDILIR (kayit yok — kullanici karari).
    ...
    {
        var result = BehaviorSignal.Create(eventType, "web", null, AnonymousId,
            ProductId, null, null, null, Occurred);
    ...
    {
        var result = BehaviorSignal.Create("ProductViewed", "web", null, Guid.Empty,
            ProductId, null, null, null, Occurred);
    ...
    {
        var result = BehaviorSignal.Create("ProductViewed", "web", null, AnonymousId,
            ProductId, null, null, null, Occurred);
