...
/// <summary>
/// Ürünün fiziksel ölçüleri (ağırlık + en/boy/yükseklik). Kargo (Shipping modülü) bunları tüketir,
/// ama ölçü ürünün fiziksel niteliği olduğu için Catalog Product aggregate'inde durur (nopCommerce paritesi).
/// </summary>
