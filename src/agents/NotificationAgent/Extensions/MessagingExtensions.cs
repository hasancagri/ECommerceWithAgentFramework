namespace NotificationAgent.Extensions;

// NotificationAgent mesajlaşma kurulumu: Wolverine + RabbitMQ (PriceAlarmTriggered tüket →
// NotificationSent yay) + retry/error-queue + handler keşfi. Program.cs orkestrasyon dışı tutulur.
public static class MessagingExtensions
{
    public static WebApplicationBuilder AddNotificationMessaging(this WebApplicationBuilder builder)
    {
