...
// Enrichment (002): gorsel byte'larini ProductId'ye gore idempotent alir, 256x256'ya
// kucultup Images/{ProductId}.png'e yazar ve deterministik public URL doner (DB YOK).
public static class UploadImage
{
    // Servis edilen gorsel boyutu (data-model): uretim 1024, File.Api 256x256'ya kucultur.
