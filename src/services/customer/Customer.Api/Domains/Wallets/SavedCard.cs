...
public class SavedCard
{
    ...
    private SavedCard(Guid id, string token, string brand, string last4, int expiryMonth, int expiryYear, string? label, string? bin)
    {
        Id = id;
        Token = token;
        Brand = brand;
    ...
    public static SavedCard Create(string token, string brand, string last4, int expiryMonth, int expiryYear, string? label, string? bin = null)
